...
public class MintegralRewardedVideo extends BaseAd implements RewardVideoListener {
    ...
    private void loadRewardVideo(Context context, Map<String, String> extras) {
        ...
        if (TextUtils.isEmpty(adMarkup)) {
            ...
            mbRewardVideoHandler.setRewardVideoListener(MintegralRewardedVideo.this);
            mbRewardVideoHandler.load();
        } else {
            mbBidRewardVideoHandler = new MBBidRewardVideoHandler(mPlacementId, mAdUnitId);
            mbBidRewardVideoHandler.setRewardVideoListener(MintegralRewardedVideo.this);
    ...
    public void onShowFail(String errorMsg) {
        failAdapter(SHOW_FAILED, FULLSCREEN_SHOW_ERROR, errorMsg, false);
    }
