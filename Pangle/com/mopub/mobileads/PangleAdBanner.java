            ...
            if (nativeAd.getImageList() != null && !nativeAd.getImageList().isEmpty()) {
                ...
                if (image != null && image.isValid()) {
                    ...
                    if (mBannerWidth / mBannerHeight >= 4) {
                        ...
                        int calculateMainImgHeight = (int) (mBannerHeight - decrptionTvLyHeight);
                        ...
                        if (mBannerWidth / mBannerHeight <= 600f / 500f) {// 1.2f
                            ...
                            if (iconLp != null) {
                                ...
                                vmlp.topMargin = (int) (scale * PangleSharedUtil.dp2px(mContext, 32));
                            ...
                            if (iconLp != null) {
                                ViewGroup.MarginLayoutParams vmlp = (ViewGroup.MarginLayoutParams) iconLp;
                                vmlp.topMargin = (int) (scale * PangleSharedUtil.dp2px(mContext, 15));
                                iconImage.setLayoutParams(vmlp);
                            }
                            ...
                            if (iconLp != null) {
                                ...
                                vmlp.width = (int) (scale * PangleSharedUtil.dp2px(mContext, 40));
                                vmlp.height = (int) (scale * PangleSharedUtil.dp2px(mContext, 40));
                                iconImage.setLayoutParams(vmlp);
                            }
                            ...
                            if (btnLp != null) {
                                ViewGroup.MarginLayoutParams vmlp = (ViewGroup.MarginLayoutParams) btnLp;
                                vmlp.bottomMargin = (int) (scale * PangleSharedUtil.dp2px(mContext, 4));
