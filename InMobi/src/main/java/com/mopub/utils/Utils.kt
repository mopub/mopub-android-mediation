...
object Utils {
    fun getMoPubErrorCode(statusCode: InMobiAdRequestStatus.StatusCode?): MoPubErrorCode {
        return when (statusCode) {
            ...
            InMobiAdRequestStatus.StatusCode.REQUEST_INVALID -> MoPubErrorCode.ADAPTER_CONFIGURATION_ERROR
            InMobiAdRequestStatus.StatusCode.NETWORK_UNREACHABLE -> MoPubErrorCode.NETWORK_INVALID_STATE
            ...
            InMobiAdRequestStatus.StatusCode.SERVER_ERROR -> MoPubErrorCode.SERVER_ERROR
