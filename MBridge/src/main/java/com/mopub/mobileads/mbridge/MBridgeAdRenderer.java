...
public class MBridgeAdRenderer implements MoPubAdRenderer<MBridgeNative.MBridgeNativeAd> {
    ...
    public MBridgeAdRenderer(final ViewBinder viewBinder) {
    ...
    @Override
    public void renderAdView(@NonNull View view, @NonNull MBridgeNative.MBridgeNativeAd ad) {
    ...
    public boolean supports(@NonNull BaseNativeAd nativeAd) {
        ...
        return nativeAd instanceof MBridgeNative.MBridgeNativeAd;
    }

    private void update(final NativeViewHolder nativeViewHolder,
                        final MBridgeNative.MBridgeNativeAd nativeAd) {
    ...
    static class NativeViewHolder {
        ...
        static NativeViewHolder fromViewBinder(final View view, final ViewBinder viewBinder) {
            ...
            try {
                ...
                MoPubLog.log(CUSTOM_WITH_THROWABLE, "Could not cast from id in ViewBinder to " + "expected View type", exception);
